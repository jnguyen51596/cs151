...
/**
 * ManagerView class extends JFrame and implements Changelistener
 * This class constructs the Manager view, which contains elements
 * such as buttons, Label and textareas neccesary to give the user
 * a responsive GUI
 */
public class ManagerView extends JFrame implements ChangeListener
{
	...
	private int spaceCounter;
        ...
        /**
         * Constructs the ManagerView which contains a calendar that is in the Model object
	...
	public ManagerView(Model m)
	{
                ...
                for(int col = 0; col< 7; col++)
		{
			...
			calendarBtn[row][col].setForeground(Color.black);
                        ...
                        //When the managers Click on a day
