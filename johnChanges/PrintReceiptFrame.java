...
/**
 * PrintReceiptFrame class constructs the GUI for the Print interface
 * contains buttons that change the interface information accordingly
 */
public class PrintReceiptFrame extends JFrame
{
    ...
    /**
     * Constructs a print Receipt Frame, adds all the elements to the panel 
     * @param m a model object
     * @param welcomeFrame  the principal Frame
     */
